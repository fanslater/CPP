...
CXmlIniReader::CXmlIniReader( int filetype, const std::string& filepath )
{
    clean();
    try
    {
...
bool CXmlIniReader::is_load_success()
{
    return m_bLoadFlag;
}

void CXmlIniReader::get_last_err( int& iCode, std::string& strMsg )
{
