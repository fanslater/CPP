...
CInstanceEvent::CInstanceEvent(void)
{
}
...
HRESULT CInstanceEvent::DealWithSingleItem( CComBSTR bstrName, CComVariant Value, CIMTYPE type, LONG lFlavor )
{
...
HRESULT CInstanceEvent::DealWithUnknownTypeItem( CComBSTR bstrName, CComVariant Value, CIMTYPE type, LONG lFlavor )
{
    HRESULT hr = WBEM_S_NO_ERROR;
...
VOID CInstanceEvent::PrintfItem( CComBSTR bstrName, CComVariant Value, CIMTYPE type, LONG lFlavor )
{
